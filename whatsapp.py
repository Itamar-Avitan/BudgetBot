...
def get_gpt():
    ...
    if gpt is None:
        try:
            ...
            print("Initializing GPT API with gpt-4o-mini (reliable model)...")
            gpt = GPT_API(api_key=GPT_API_KEY, model="gpt-4o-mini")
            # Test the connection with a simple call
            test_response = gpt._call_chat([{"role": "user", "content": "Hello"}], temp=0, max_t=10)
            print("GPT-4o-mini initialization successful!")
        except Exception as e:
            print(f"ERROR: GPT-4o-mini initialization failed: {e}")
            ...
            try:
                print("Trying gpt-4.1-mini as fallback...")
